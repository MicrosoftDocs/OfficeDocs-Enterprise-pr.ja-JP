...
1. [**説明**] などの列を右クリックします。
2. [**列の選択] を**クリックします。
3. リスト内で_NTLMSSP の概要_と_時間デルタ_を見つけ、[**追加**] をクリックします。
