...
# アクセス可能な図 - Microsoft Lync 2013 プラットフォーム オプション

この記事は、Microsoft Lync 2013 プラットフォーム オプションという名前のダイアグラム ([技術ダイアグラム](http://go.microsoft.com/fwlink/?LinkID=519139&amp;clcid=0x409) で利用できます) のアクセス可能なテキスト バージョンです。
...
## Lync 2013 プラットフォーム用の 4 つの異なる展開の比較
...
#### Lync Online/Server ハイブリッド (ドメインを分割)
...
### Microsoft Azure のディレクトリ同期コンポーネント
...
### Office 365 内での Lync と Exchange、SharePoint との統合

#### Lync Server を Exchange Online および SharePoint Online と併用する
