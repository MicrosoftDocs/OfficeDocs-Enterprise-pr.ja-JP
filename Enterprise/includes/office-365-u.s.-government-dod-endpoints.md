...
ID | カテゴリ | ER | 住所 | ポート
-- | -------------------- | --- | ---------------------------------------------------------------------------------------------------- | ----------------
9  | 最適化<BR>必須 | はい | `*.dps.mil, *.sharepoint-mil.us`<BR>`104.212.48.0/23, 2001:489a:2204::/63` | **TCP:** 443、80
10  | 既定値<BR>必須 | いいえ | `g.live.com, odc.officeapps.live.com, officeclient.microsoft.com, oneclient.sfx.ms, wns.windows.com` | **TCP:** 443、80
...
8 | 既定値<BR>必須 | はい | `*.dod.teams.microsoft.us, *.online.dod.skypeforbusiness.us, dod.teams.microsoft.us` | **TCP:** 5061、50000-59999<BR>**UDP:** 50000-59999
21 | 既定値<BR>必須 | いいえ | `statics.microsoft.com` | **TCP:** 443
