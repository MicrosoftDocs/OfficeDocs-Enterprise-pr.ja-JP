...
ID | カテゴリ | ER | 住所 | ポート
-- | -------------------- | --- | ---------------------------------------------------------------------------------------------------- | ----------------
9  | 最適化<BR>必須 | はい | `*.dps.mil, *.sharepoint-mil.us`<BR>`20.34.12.0/22, 104.212.48.0/23, 2001:489a:2204::/63` | **TCP:** 443、80
...
21 | 既定値<BR>必須 | いいえ | `statics.teams.microsoft.com` | **TCP:** 443
