...
# 分離した SharePoint Online チーム サイトの展開
...
## フェーズ 1:チーム サイト アクセス グループの作成と設定
...
### 手順 1:サイトの SharePoint Online 管理者を一覧表示する
...
### 手順 4:Azure AD でサイト用の 3 つのアクセス グループを作成する
...
3. **[すべてのグループ]** ブレードで、 **[+ 新しいグループ]** をクリックします。
    
4. **[グループ]** ブレードでの手順:
    
  - **[名前]** にグループ名を入力します。
    
  - **[メンバーシップ]** で **[割り当て済み]** を選択します。
    
  - **[Office の機能を有効にする]** で **[はい]** をクリックします。
...
### 手順 5:アクセス グループにユーザー アカウントを追加する
