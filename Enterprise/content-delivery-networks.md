...
この情報を使用して、コンテンツ配信ネットワーク (cdns) と、Office 365 がそれらを活用する方法について説明します。 cdns は、エンドユーザーにとって Office 365 を高速かつ信頼性の高い状態に保つことができます。 cdns を使用すると、Office 365 などのクラウドサービスは、web クライアントを介してサービスを使用しているときに、アイコンなどの一般的なコンテンツをユーザーのブラウザーにすばやくダウンロードします。
...
[Office 365 へのネットワーク接続](network-connectivity.md)を計画している場合は、cdns のしくみを理解することをお勧めします。 IP アドレスによる cdns への接続をフィルターできないことも理解しておくことが重要です。 Exchange Online などの Office 365 内のサービスについては、ベストエフォート型の ip のリストを提供しています。 [Office 365 エンドポイントの管理](https://support.office.com/article/99cab9d4-ef59-4207-9f2b-3728eb46bf9a)に関する推奨事項の詳細については、こちらを参照してください。
...
fqdn の一覧と、時間の経過とともに cdns の変更をどのように活用するかについては、「公開された[Office 365 エンドポイント」ページ](https://go.microsoft.com/fwlink/p/?LinkID=293744)を参照して、cdns を利用する最新の fqdn を最新の状態にします。
...
+ office 365 のプライバシーとデータ保護の詳細については、「 [office 365 のセキュリティセンター」](https://go.microsoft.com/fwlink/p/?LinkId=397383)を参照してください。
