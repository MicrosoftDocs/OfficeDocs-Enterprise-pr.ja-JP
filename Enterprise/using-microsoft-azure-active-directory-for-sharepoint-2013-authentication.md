...
---
# <a name="using-microsoft-azure-active-directory-for-sharepoint-2013-authentication"></a>SharePoint 2013 認証に Microsoft Azure Active Directory を使用する
...
## <a name="create-azure-ad-tenant-and-namespace"></a>Azure AD テナントと名前空間の作成
...
## <a name="add-a-ws-federation-identity-provider-to-the-namespace"></a>名前空間への WS-Federation IP プロバイダーの追加
...
## <a name="add-sharepoint-as-a-relying-party-application"></a>証明書利用者アプリケーションとしての SharePoint の追加
...
## <a name="create-a-rule-group-for-claims-based-authentication"></a>クレーム ベース認証のための規則グループの作成
...
## <a name="configure-the-x509-certificate"></a>X.509 証明書の構成
...
## <a name="create-a-claim-mapping-by-using-windows-powershell"></a>Windows PowerShell によるクレーム マッピングの作成
...
## <a name="configure-sharepoint-for-the-new-identity-provider"></a>新しい ID プロバイダー用の SharePoint の構成
...
## <a name="set-the-permissions"></a>アクセス許可の設定
...
## <a name="verify-the-new-provider"></a>新しいプロバイダーの確認
