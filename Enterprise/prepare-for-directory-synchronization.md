...
[Azure AD 接続で、Azure Active directory 属性を同期](https://docs.microsoft.com/azure/active-directory/hybrid/reference-connect-sync-attributes-synchronized)するも参照してください。
