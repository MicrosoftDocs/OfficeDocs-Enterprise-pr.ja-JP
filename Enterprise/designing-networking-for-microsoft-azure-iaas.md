...
ゲートウェイのサブネットが、Azure ゲートウェイと仮想マシンを含む仮想マシン ホストのサブネットのセットを含む、VNet を図 3 に示します。
...
Azure ゲートウェイのサブネットのアドレス空間を決定するためのベスト プラクティスは次のとおりです。
...
次の方法では、ローカル ネットワークのアドレス空間を定義できます。
