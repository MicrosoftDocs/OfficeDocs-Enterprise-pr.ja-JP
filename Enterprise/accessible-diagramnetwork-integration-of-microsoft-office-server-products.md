...
# アクセス可能な図 - Microsoft Office Server 製品のネットワーク統合

この記事は、「Microsoft Office Server 製品のネットワーク統合」という名前の図のアクセス可能なテキスト バージョンです。
...
## Lync、Exchange、SharePoint サーバー、および Office Web Apps の大まかな概念
...
#### Lync と SharePoint のリモート アクセス サーバー
...
#### トラフィックがコンポーネントを経由して別のサーバー層に移動する方法の説明
...
#### パートナー会社 (企業間) (https://partnerweb.contoso.com)
...
#### 個々のパートナー (SharePoint) と匿名 (Lync) (https://partnerweb.contoso.com および https://meet.contoso.com)
...
#### Lync の SIP トラフィックと Lync の web トラフィック
...
#### Exchange クライアントのトラフィックと Exchange メール サーバーのトラフィック
