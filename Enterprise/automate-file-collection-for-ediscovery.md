...
### ログオン スクリプトと保管担当者グループの GPO を構成します。
...
### PST インポートのオプション A (Exchange Server 2013 用のスクリプト)
...
### PST インポートのオプション B (Exchange Online の場合)
...
### コールド ストレージ用 SharePoint オンプレミス検索
...
### PST インポートのオプション A (Exchange Server 2013 の場合)
