...
[![Microsoft クラウド ID モデルのサムネイル イメージ](images/ffa145a1-97e6-4c36-b08b-01c4a4ae8b9b.png)
...
> [!NOTE]
> この記事は「 **エンタープライズ アーキテクトのための Microsoft クラウド ID**」ポスター (2016 年 1 月版) を反映しています。ポスターの 2016 年 4 月版の変更点は含まれていません。 
