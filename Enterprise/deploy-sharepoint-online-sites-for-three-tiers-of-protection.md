...
詳細な手順については、「[Deploy an isolated SharePoint Online team site](deploy-an-isolated-sharepoint-online-team-site.md)」(分離した SharePoint Online チーム サイトの展開) の「**Phase 1**」(フェーズ 1) を参照してください。
...
詳細な手順については、「[Deploy an isolated SharePoint Online team site](deploy-an-isolated-sharepoint-online-team-site.md)」(分離した SharePoint Online チーム サイトの展開) を参照してください。
