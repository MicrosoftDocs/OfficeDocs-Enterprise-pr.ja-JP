...
# アクセス可能な図 - Microsoft Azure に対する SharePoint の障害復旧

この資料は、「Microsoft Azure に対する SharePoint の障害復旧」という名前の図のアクセス可能なテキスト バージョンです。
  
このポスターは、Azure で回復環境を構築するためのアーキテクチャの例を示します。 
  
## Azure 回復環境のあるオンプレミスの環境
