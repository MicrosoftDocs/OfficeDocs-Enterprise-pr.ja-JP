...
## <a name="office-2010-planning-roadmaps"></a>Office 2010 の計画のロードマップ
  
|**この製品の**|**この計画のロードマップを参照してください。**|
|:-----|:-----|
...
次のオプションのいずれかを選択します。
- **Office 365 を自宅で使用してみてください**。[生産性の向上-Office 365 現在 Office 2007 からのアップグレード](https://go.microsoft.com/fwlink/?linkid=733276)。
    
- **ホームの使用を Office 365 を購入**します。サブスクリプションの Office 365 ホーム] または [Office 365 の個人の間で選択し、[サインアップでは、Windows または Mac コンピューター、スマート フォン、およびタブレットの最新バージョンの Office をインストールします。OneDrive では、クラウド ストレージを楽しむこと、毎月、モバイル Skype 呼び出しの 60 分と地上線の番号を取得、およびその他の多くの優れた機能を取得します。 
