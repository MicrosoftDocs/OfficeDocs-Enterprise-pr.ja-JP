...
![図 1:ExpressRoute のないネットワーク パス](images/27796846-3b0a-4bbc-8b39-22552d037fba.png)
...
![図 2: ExpressRoute のあるネットワーク パス](images/a22eccb1-e3d2-4c69-a751-6539ffc0d8c2.png)
...
|:-----|:-----|:-----|
|![ExpressRoute 接続モデル:Cloud Exchange でのコロケーション](images/415cd5b2-2b5a-4aeb-8018-8af61d9f9ab6.png)|![ExpressRoute 接続モデル:ポイント ツー ポイントのイーサネット](images/0582afa7-b46d-4da9-80ff-f0553ac93676.png)|![ExpressRoute 接続モデル:Any-to-Any (IP VPN) 接続](images/2884618e-ff38-471a-a1e0-fd55483938e5.png)|
...
![図 3: 単一の ExpressRoute 接続が対応する 3 つの異なる BGP 関係](images/f16e3eaf-9fd5-4513-9a15-dcf66f07756f.png)
...
![図 4:オンプレミス SharePoint ファームにアクセスする Azure 仮想マシン上のアプリケーション](images/293dbdb7-e8f6-4399-8fdd-b7e4d0b33e66.png)
...
![図 5: オンプレミスの SharePoint ファームを SharePoint Online に移行する](images/d2140875-5fd3-44ce-b863-e93ad8680038.png)
...
![図 6:SharePoint ファームが Office 365 の SharePoint Online に移行したときのトラフィック フロー](images/30623d29-a9e6-4d38-bb7a-683adcea3395.png)
...
![図 7: 単一の ExpressRoute 接続を使用する地理的に分散した組織の例](images/f0c19a74-d67c-42de-8b1a-a122729b4abb.png)
...
![図 8: 地域のデータ センターへの最適な配信を確保するために複数の ExpressRoute 接続を使用する](images/e6980050-48ee-41f7-9f81-7953e783ee1b.png)
...
![図 9: 全世界をカバーする Microsoft のクラウド ネットワーク](images/c65c740a-f20c-4c77-b3b2-624b39ef0aa3.png)
