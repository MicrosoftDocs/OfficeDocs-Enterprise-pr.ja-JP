...
1. デスクトップ コンピューター (軽量) のいずれかのブラウザーを使用してまたは CLIENT1 から (エンタープライズをシミュレートする)、グローバル管理者アカウントの資格情報を持つ[https://portal.office.com](https://portal.office.com)で、Office 365 ポータルにサインインします。
