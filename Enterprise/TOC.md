...
### [Microsoft 365 での分離コントロール](office-365-isolation-controls.md)
### [Microsoft 365 での担当者の制御](office-365-personnel-controls.md)
### [Microsoft 365 での技術による制御](office-365-technology-controls.md)
### [Yammer Enterprise でのアクセス制御](office-365-yammer-enterprise-access-controls.md)
## [Microsoft 365 での監査とレポート](office-365-auditing-and-reporting-overview.md)
...
## [Microsoft 365 でのデータの回復性](office-365-data-resiliency-overview.md)
...
## [Microsoft 365 でのデータの保持、削除、および破棄](office-365-data-retention-deletion-and-destruction-overview.md)
### [データの破棄](office-365-data-destruction.md)
### [Microsoft 365 での不変性](office-365-data-immutability.md)
...
## [Microsoft 365 でのテナントの分離](office-365-tenant-isolation-overview.md)
