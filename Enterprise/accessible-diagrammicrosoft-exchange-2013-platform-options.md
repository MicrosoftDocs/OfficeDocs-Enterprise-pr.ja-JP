...
# アクセス可能な図 - Microsoft Exchange 2013 プラットフォーム オプション

この記事は、Microsoft Exchange 2013 プラットフォーム オプションという名前のダイアグラム ([技術ダイアグラム](http://go.microsoft.com/fwlink/?LinkID=519139) で利用できます) のアクセス可能なテキスト バージョンです。
...
## Exchange 2013 プラットフォーム用の 4 つの異なる展開の比較
...
## Exchange 2013 での 3 つの新規または更新された機能の説明
